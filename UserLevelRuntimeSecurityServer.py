...
def authenticateLogin():
    ...
    conn1 = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
    cur1 = conn1.cursor()
...
def CloudProviderDataListing():
    ...
    if searchData == None:
        searchData = "";
    conn2 = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
    cursor = conn2.cursor()
...
def ProcessCloudProviderDataOperation():
    ...
    print(operation)
    conn3 = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
    cur3 = conn3.cursor()
...
def ProcessRoleOperation():
    ...
    if operation == "Delete" :
        conn4 = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
        cur4 = conn4.cursor()
...
def UserListing():
    ...
    if searchData == None:
        searchData = "";
    conn = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
    cursor = conn.cursor()
...
def ProcessBlockchainGeneration():
    ...
    if blocksCreated != 0 :
        connx = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
        ...
        if dbrowx:
            videoid = dbrowx[0]
            conny = pypyodbc.connect('Driver={SQL Server};Server=WISEN\\SQLEXPRESS;Integrated_Security=true;Database=E05-UserLevelRuntimeSecurityV1', autocommit=True)
